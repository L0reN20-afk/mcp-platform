...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    // DISCORD RIMOSSO - causava errore "Element type is invalid"
    { Icon: null, href: '#discord', label: 'Discord', text: 'D' } // Placeholder testuale
  ]
  ...
  return (
    <footer className="relative bg-black border-t border-white/10">
      ...
      <div className="fixed bottom-0 left-0 w-full h-1 bg-white/10 z-50">
        <div className="scroll-progress h-full bg-gradient-to-r from-primary-500 to-accent-500 transform-gpu origin-left"></div>
      </div>
    </footer>
  )
}